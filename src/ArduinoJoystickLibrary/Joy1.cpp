...
void Joy1_::setHatSwitch(const uint8_t value) {
  if(_GamepadReport.hat != value)
    _stateChanged = true;
  _GamepadReport.hat = value;
}

void Joy1_::setAnalog0(const uint8_t value) {
  if(_GamepadReport.analog0 != value)
    _stateChanged = true;
  _GamepadReport.analog0 = value;
}
void Joy1_::setAnalog1(const uint8_t value) {
  if(_GamepadReport.analog1 != value)
    _stateChanged = true;
  _GamepadReport.analog1 = value;
}
void Joy1_::setAnalog2(const uint8_t value) {
  if(_GamepadReport.analog2 != value)
    _stateChanged = true;
  _GamepadReport.analog2 = value;
}
void Joy1_::setAnalog3(const uint8_t value) {
  if(_GamepadReport.analog3 != value)
    _stateChanged = true;
    _GamepadReport.analog3 = value;
}
void Joy1_::setAnalog4(const uint8_t value) {
  if(_GamepadReport.analog4 != value)
    _stateChanged = true;
  _GamepadReport.analog4 = value;
}
